...
//게시글 작성
router.post("/api/articles/:index", (req, res) => {
...
//인덱스 조회
router.get('/api/articles/idxs', (req, res) => {
...
//게시글 수정
router.put("/api/articles/:index", (req, res) => {
...
// //게시글 삭제
router.delete("/api/articles/:index", (req, res) => {
